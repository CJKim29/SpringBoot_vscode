...
public class SawonController {
    ...
    @RequestMapping("/sawon/listsajob.do")
    public String listSajob(Model model){

        List<SawonVo> list = sawon_Dao.selectListSajob("부장");
        //System.out.println(list.size());
        model.addAttribute("list", list);
    ...
    @RequestMapping("/sawon/listsabun.do")
    public String listSabun(Model model){

        List<SawonVo> list = sawon_Dao.selectListSabun(10);
        //System.out.println(list.size());
        model.addAttribute("list", list);
